...
// NOTE: SplitText is a premium GSAP plugin. If not valid, this import will fail in standard builds.
// For this demo, assuming user has access or we might need a fallback.
// If this fails, we will need to replace SplitText with a manual splitter.
        ...
        () => {
            ...
            const build = () => {
                ...
                try {
                    ...
                    console.warn("GSAP SplitText failed (likely missing license). Shuffle effect disabled.", e);
                    return;
                }
