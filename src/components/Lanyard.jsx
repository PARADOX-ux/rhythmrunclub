...
export default function Lanyard({ position = [0, 0, 20], gravity = [0, -40, 0], fov = 20, transparent = true }) {
    ...
    return (
        <div className="lanyard-wrapper">
            ...
            {/* DEBUG: Static Card Render (No Physics) */}
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
    ...
    // Removed useGLTF for card.glb to avoid loading issues
        ...
        <>
            <group position={[0, 0, 0]}>
                ...
                <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
                    ...
                    >
                        {/* Manual Card Geometry - Replaces GLB */}
                        <mesh>
                            <boxGeometry args={[0.8, 1.125, 0.01]} />
                            <meshPhysicalMaterial
                                color="white"
            ...
            <mesh ref={band}>
                <meshLineGeometry />
                <meshLineMaterial color="#FC4C02" depthTest={false} resolution={isMobile ? [1000, 2000] : [1000, 1000]} useMap map={texture} repeat={[-4, 1]} lineWidth={1} />
            </mesh>
        </>
    );
}
