        ...
        <div className="w-full max-w-6xl py-20 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {runners.map((runner, index) => (
                    <div key={index} className="group relative h-[400px] overflow-hidden rounded-2xl border border-white/10 bg-zinc-900 cursor-pointer hover:border-orange-500/50 transition-colors duration-500">
