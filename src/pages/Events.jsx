                            ...
                            <>
                                ...
                                <div className="flex justify-between items-start mb-8">
                                    <div>
                                        ...
                                        <p className="text-xl text-white font-bold">11th January 2026 • 6:00 AM • Yelahanka Main Gate</p>
                                    </div>
                                </div>

                                <div className="flex flex-col items-center justify-center py-20 text-center space-y-6">
                                    <div className="w-24 h-24 bg-orange-500/10 rounded-full flex items-center justify-center animate-pulse">
                                        <span className="text-4xl">🚧</span>
                                    </div>
                                    <h3 className="text-3xl font-black text-white tracking-tight">UPDATES ON THE WAY</h3>
                                    <p className="text-gray-400 max-w-md mx-auto">
                                        We are finalizing the route and logistics for this Sunday's run.
                                        Check back soon for the map and full details!
                                    </p>
                                </div>
                            </>
                        ) : ticket ? (
                                    ...
                                    <div className="border-y-2 border-dashed border-gray-300 py-8 my-8 space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <p className="font-bold">01 JAN 2026</p>
                                            </div>
                                            <div>
                                                <p className="text-xs text-gray-500 uppercase">Time</p>
                                                <p className="font-bold">6:00 AM</p>
                                            </div>
                                        </div>
                                    </div>
